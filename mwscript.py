...
if len(script.split('/')) == 1:
    script = f'{MWPATH}/maintenance/{sys.argv[1]}'
else:
...
if wiki in ('all', 'foreachwikiindblist'):
    ...
    generate = f'php {MWPATH}/extensions/MirahezeMagic/maintenance/generateExtensionDatabaseList.php --wiki=loginwiki --extension={extension}'  #  noqa: E501
